            ...
            function [b, result] = test_python(ndi_app_spikesorter_hengen_obj)
                ...
                function extract_and_sort(ndi_app_spikesorter_hengen_obj, varargin)
                    ...
                    elseif numel(extraction_doc) > 1
                        ...
                        function rate_neuron_quality(ndi_app_spikesorter_hengen_obj, probe)
                            ...
                            d = ndi.document('apps/spikesorter_hengen/spikesorter_hengen_clusters.json', ...
                                'ndi_document.name', 'lalalala');
                            d = d.set_dependency_value('element_id', probe.id());
                            ndi_app_spikesorter_hengen_obj.session.database_add(d);
                            ...
                            for i = 1:2% TODO: hardcoded
                                ...
                                % neuron_element = ndi.neuron(ndi_app_spikesorter_hengen_obj.session, ...
                                ...
                                dependency = struct('hengen', 'hengen')
                                ndi_app_spikesorter_hengen_obj

                                ndi_app_spikesorter_hengen_obj.session.reference

                                neuron_element = ndi.neuron(probe.session, ...
                                    ['neuron_' num2str(neuron.clust_idx + 1)], ...
                                    probe.reference, ...
                                    'spikes', ...
                                    probe, ...
                                ...
                                size(neuron.waveform, 1)

                                neuron_extracellular.number_of_samples_per_channel = [1, 1, 1, 1]
                                ...
                                neuron_doc = ndi.document('neuron/neuron_extracellular.json', 'neuron_extracellular', neuron_extracellular);

                                neuron_doc = neuron_doc.set_dependency_value('element_id', neuron_element.id());

                                ndi_app_spikesorter_hengen_obj.session.database_add(neuron_doc)
